          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="bg-muted/50 border-b">
                <th className="px-3 py-2 text-left font-medium">প্রোডাক্ট</th>
                <th className="px-3 py-2 text-right font-medium">দাম</th>
                <th className="px-3 py-2 text-center font-medium">পরিমাণ</th>
                <th className="px-3 py-2 text-right font-medium">সাবটোটাল</th>
            ...
            <tfoot>
              <tr className="bg-muted/30">
                <td colSpan={isEditing ? 3 : 3} className="px-3 py-2 text-right font-medium">
                  মোট:
                </td>
          ...
          <div className="flex flex-col sm:flex-row gap-2">
            <Select onValueChange={handleAddItem}>
              <SelectTrigger className="flex-1">
                <SelectValue placeholder="নতুন প্রোডাক্ট যোগ করুন..." />
              </SelectTrigger>
              <SelectContent>
