...
import { Search, BookOpen, CheckSquare, XSquare } from 'lucide-react';
...
// Generate preview HTML with proper fonts
          ...
          {isLoading ? (
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
              {filteredComponents.map((component) => {
                ...
                const previewHtml = generatePreviewHtml(component.html);
